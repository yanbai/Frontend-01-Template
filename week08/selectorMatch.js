...
// let res_7 = match('h2[name="product_error"]', document.getElementById('ele_2'))
// let res_8 = match('h2[name^="error"]', document.getElementById('ele_2'))
// let res_9 = match('h2[name$="error"]', document.getElementById('ele_2'))
// let res_10 = match('h3', document.getElementById('ele_2'))
// let res_11 = match('#ab', document.getElementById('ele_2'))
// let res_12 = match('.tt', document.getElementById('ele_2'))

// let res_13 = match('.container > .title', document.getElementById('ele_1'))
// let res_14 = match('.container > .error', document.getElementById('ele_1'))
// let res_15 = match('.error > .title', document.getElementById('ele_1'))

// let res_16 = match('.title + [name="product_title"]', document.getElementById('ele_2'))
// let res_17 = match('.error + [name="product_title"]', document.getElementById('ele_2'))
// let res_18 = match('.title + .error', document.getElementById('ele_2'))
...
let res_21 = match('.error [name="product_title"]', document.getElementById('ele_2'))
let res_22 = match('.page [name="error"]', document.getElementById('ele_2'))
